...
run;
%mend imp;
/*%imp(/schaeffer-a/sch-projects/dua-data-projects/AESOPS/R33_NU/Recent_12June24/Data, rx_temp, savepath.rx);
...
*combine with index encounters and total visit MME;
proc sql;
...
*BPA trigger criteria for 90 days, and 3-6 months;
*Naive and At-risk 90-days;
