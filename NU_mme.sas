...
***2. Exclude cancer patients, < 18, and non-participating clinicians (DONE-patients with cancer Dxs and other clinicians already excluded)
***3. Merge with BPA file, and get observed BPA per encounter 
***4. Classify visits as A, B, or C 
***ES  June 12, 2024
...
**SOURCE DATA
*****ANALYTIC: schaeffer-a/sch-data-library/dua-data/AESOPS/Original_data/Data/AESOPS_Trial1_Prescription 
*****MME CROSSWALK: schaeffer-a/sch-projects/dua-data-projects/AESOPS/R33_NU/Data, mme_cw
**CREATED FILES 
*******************************************************************************************************************/

ods pdf file = "/schaeffer-a/sch-projects/dua-data-projects/AESOPS/R33_NU/Recent_12June24/Results/NU_consort_cts_12Dec24.pdf";
...
run;
%mend imp;
%imp(/schaeffer-a/sch-projects/dua-data-projects/AESOPS/R33_NU/Recent_12June24/Data, rx_temp, rx);
%imp(/schaeffer-a/sch-projects/dua-data-projects/AESOPS/R33_NU/Data, mme_cw, cw);
%imp(/schaeffer-a/sch-projects/dua-data-projects/AESOPS/R33_NU/Recent_12June24/Data, AESOPS_R33_Trial1_ClinicianDemo, clinicians);
%imp(/schaeffer-a/sch-data-library/dua-data/AESOPS/Original_data/Data/20240731_Download, AESOPS_R33_Trial1_BPA, bpas);
...
*add BPA label (A, B, C) for BPA file and 
proc sql;
...
*BPA counts;
proc sql;
	Title "Observed BPA counts";
	select count(*) as BPA_ct, BPA from savepath.bpa_sample
	group by bpa;
quit;
